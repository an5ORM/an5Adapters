...
try {
  ...
  fs.writeFileSync(
    ...
    [
      ...
      `const pkgDir = path.join(__dirname, 'node_modules', '@an5', 'adapters');`,
      ``,
      ...
      `  ['python/an5_adapter.py','dotnet/An5Adapter.cs','golang/an5_adapter.go','golang/table_client.go'].forEach(rel => {`,
